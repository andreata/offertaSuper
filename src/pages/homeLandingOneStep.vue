<template>
    <Layout>
        <div>
            <div class="full-container bg-home-4">
                <div class="container">
                    <h1 class="title-home desk">Abbiamo selezionato per te<br> la migliore offerta Internet Casa</h1>
                    <p class="p-home desk">I nostri parametri sono:</p>
                    <p class="orange-home font-bold desk">miglior prezzo, miglior servizio, miglior assistenza</p>

                    <div class="mobl">
                        <div class="home-layout-mobile">
                            <div>
                                <h1 class="title-home-mobile mobl">Abbiamo selezionato per te</h1>
                                <p class="p-home-mobile mobl">La migliore offerta Internet Casa </p>
                            </div>
                            <g-image class="img-hero" src="~/assets/images/icon/eroe-lampadina.svg" alt=""
                                width="300" />
                    ...
                    <form-landing-one-step />

                </div>
            </div>

            <div class="full-container desk">
                <div class="container">
                    <h1 class="title-home">Noi selezioniamo, tu risparmi</h1>
                    ...
                    <div class="container-box">
                        ...
                        <div class="item-box">
                            ...
                            <p class="p-promo-standard"> <span>Selezionate da Offerta Super in esclusiva per te!</span>
                            </p>
            ...
            <div class="full-container copy-area">
                <div class="container">
                    <div class="grid-two-column">
                        ...
                        <div class="flex-content-copy">
                            <div>
                                ...
                                <p>Il nostro selezionatore è in grado di trovare con estrema precisione la migliore
                                    offerta per TE.</p>
                                <p class="content-2">Che abbia il miglio prezzo, chiaro e trasparente.Che possa
                                    fornirti
                                    un servizio di
                                    qualità e senza
                                    vincoli.</p>
                    ...
                    <div class="grid-five-column">
                        <div>
                            ...
                            <div>
                                ...
                                <p class="grey-font">Nulla vitae elit libero, a pharetra augue. Aenean eu leo quam.
                                    Nulla
                                    vitae elit
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <p class="grey-font">Abbiamo selezionato le migliori soluzioni per la tua casa e ti
                        ...
                        <div>
                            <g-image class="img-salmone" src="~/assets/images/icon/icon-risparmio.svg" alt=""
                                width="60" />
                            <div>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <p class="grey-font">Ti garantiamo la miglior assistenza sulla tua offerta e potrai
                                    sempre
                                    contattarci per
...
import FormLandingOneStep from '~/components/FormLandingOneStep.vue'
